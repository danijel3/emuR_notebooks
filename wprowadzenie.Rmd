...
* użytkownicy Windowsa wybierają opcję *base* i ściągają instalator _R 3.4.4 for Windows_
* użytkownicy Mac OS X ściągają _R-3.4.4.pkg_ i uruchamiają ten instalator
...
Jeśli powyższe dwa kroki zawiodą, istnieje jeszcze jedna alternatywna metoda uczestnictwa w warsztatach. Dla ograniczonej ilości uczestników możemy udostępnić podobne środowisko poprzez stronę WWW. Jeśli nie jesteś w stanie zainstalować programu na swoim komputerze, zgłoś się do prowadzącego o dostęp do języka R przez stronę WWW.
...
* `install.pakacages("NAZWA_PAKIETU")`
